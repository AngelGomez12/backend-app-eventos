...
import { AttendanceStatus, DietaryRestriction } from "@/contexts/events/domain/guest.entity";
...
describe("UpdateGuestDto", () => {
  it("should validate a correct DTO", async () => {
    ...
    dto.phone = "+54...";
    dto.dietaryRestrictions = DietaryRestriction.VEGAN;
  ...
  it("should allow null for tableId", async () => {
    const dto = new UpdateGuestDto();
    (dto as any).tableId = null;
