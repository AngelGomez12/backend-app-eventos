...
export class RsvpController {
  ...
  @ApiOperation({
    ...
    description:
      "Retrieves invitation data using a unique token. Used to show the confirmation screen to guests.",
  })
  @ApiParam({
    name: "token",
    description: "The unique token provided in the guest's invitation link.",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Allows a guest to submit their RSVP status using their unique token.",
  })
  @ApiParam({
    name: "token",
    description: "The unique token provided in the guest's invitation link.",
